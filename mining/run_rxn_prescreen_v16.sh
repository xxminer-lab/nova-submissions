...
urllib.request.urlretrieve(base + "score_candidates_incr_v16.py", "/nova/score_candidates_incr_v16.py")
...
python3 /nova/score_candidates_incr_v16.py --candidates /nova/candidates.tsv --out "/nova/scores_rxn${RXN_ID}.tsv" --target P40261 --limit "${LIMIT}" --offset "${OFFSET}" --batch-size 12 --batch-timeout 240 2>&1 \
