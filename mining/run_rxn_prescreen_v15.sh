...
python3 /nova/score_candidates_incr_v14.py --candidates /nova/candidates.tsv --out "/nova/scores_rxn${RXN_ID}.tsv" --target P40261 --limit "${LIMIT}" --offset "${OFFSET}" --batch-size 12 --batch-timeout 300 2>&1 \
