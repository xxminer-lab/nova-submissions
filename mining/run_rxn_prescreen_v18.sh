...
python3 /nova/score_candidates_incr_v16.py --candidates /nova/candidates.tsv --out "/nova/scores_rxn${RXN_ID}.tsv" --target P40261 --limit "${LIMIT}" --offset "${OFFSET}" --batch-size 1 --batch-timeout 120 2>&1 \
